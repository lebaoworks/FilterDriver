...
_Ret_notnull_
void* _cdecl operator new(_In_ size_t size, _Inout_updates_(size) void* buffer) { UNREFERENCED_PARAMETER(size); return buffer;}

void _cdecl operator delete(_Notnull_ __drv_freesMem(Mem) void* object) { ExFreePool(object); }
