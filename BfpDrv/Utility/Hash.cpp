...
namespace Hash::SHA256
{
    ...
    void Hasher::revert(UINT8 hash[32])
    {
    ...
    Hasher::Hasher() : m_blocklen(0), m_bitlen(0)
    {
    ...
    void Hasher::feed(const UINT8* data, size_t length)
    {
